            ...
            for (int i = 0; i < arr.GetLength(0); i++)
            {
                ...
                for (int j = firstTeamId; j <= lastTeamId; j++)
                {
                    result.Add(new Game
                    {
                        ...
                        HomeGoals = (byte)rand.Next(0, 10),
                        AwayGoals = (byte)rand.Next(0, 10),
                        HomeFauls = (byte)rand.Next(0, 20),
                        AwayFauls = (byte)rand.Next(0, 20),
                        HomePasses = rand.Next(100, 680),
                        AwayPasses = rand.Next(100, 680),
                        HomeShots = (byte)rand.Next(0, 15),
                        AwayShots = (byte)rand.Next(0, 15),
                        Date = GetRandomDate(),
                    });
                }
            }
            ...
            for (int i = 0; i < arr.GetLength(0); i++)
            {
                ...
                for (int j = firstPlayerId; j <= lastPlayerId; j++)
                {
                    result.Add(new PlayerLeagueStats
                    {
                        PlayerId = j,
                        LeagueId = leagueId,
                        Goals = rand.Next(0, 12),
                        Assists = rand.Next(0, 12),
                        Appearences = rand.Next(1, 6),
                    });
                }
            }
